...
const AppleFooter = () => {
  return (
    <Col
      className=" footer col-12 p-4 pb-0 bg-black bg-body-tertiary align-items-center text-light"
      data-bs-theme="dark"
    >
      ...
      <div className="mb-3 d-flex my-0 py-0 flex-wrap">
        <p className="mb-1">Condizioni dei servizi internet.</p>
        <p className="mb-0 opacity-25 px-2"> | </p>
